// =============================================================================
// MECHelangelo Behaviour Node — Version 1 (pre-IMU, pre-segment-filter)
//
// This was the first complete working implementation of the behaviour node.
// It used a simpler single-stage noise neighbour filter (no segment extraction),
// and open-loop time integration for ALIGNING instead of IMU-confirmed rotation.
//
// Human tracking state variables were file-scope globals rather than class members.
// The filtered scan publisher was also a global rather than a member publisher.
//
// Key differences from the current version:
//   - No IMU subscription or yaw-confirmed alignment
//   - No buildLaserSegments() / findBlockingObstaclesInFront()
//   - No RViz obstacle marker publisher
//   - Safety zone and human tracking data stored as static globals
//   - Open-loop angular velocity integration for turn estimation
// =============================================================================
