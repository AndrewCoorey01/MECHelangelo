// =============================================================================
// MECHelangelo Behaviour Node — Version 3 (first physical deployment, 0.12 m/s)
//
// First version tuned for the physical PiBorg base. Forward and approach speeds
// were lowered to stay within the motor driver limits measured on the real hardware.
//
// Key constants vs v2 (simulation):
//   - kForwardSpeed = 0.12 m/s  (slowest reliable DVD cruise on physical base)
//   - kTurnSpeed    = 0.375 rad/s (minimum reliable in-place turn)
//   - kUltrasonicApproachMaxSpeed = 0.12 m/s
//   - kStopDurationLoops = 5 (0.5 s pause — physical bounce is faster)
//   - IMU yaw subscription added but open-loop integration still used for turns
//
// This version was replaced by v4 which increased cruise speed to 0.15 m/s
// and added pulsed LiDAR-primary stopping for the human approach.
// =============================================================================
