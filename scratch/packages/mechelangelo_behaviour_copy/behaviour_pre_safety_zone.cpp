// =============================================================================
// SCRATCH COPY — behaviour.cpp as of 2026-05-28
// Saved before safety-zone interrupt was added.
//
// FUNCTIONALITY OF THIS VERSION:
//   Implements the five-state sentry/interaction state machine.
//   HUMAN_DETECTED drives toward the tracked human using /human_tracking data
//   (Float32MultiArray: [detected, centre_offset, distance_m]) and stops at
//   ~1.5 m using LiDAR-validated distance.  No safety zone exists — any object
//   entering the 1.5 m radius during interaction is silently ignored and the
//   robot continues driving/turning.
//
//   The commented-out block below is an older, simpler iteration of the
//   HUMAN_DETECTED state that just called stopRobot().
// =============================================================================
