...
class MqttBridge(Node):
    def __init__(self):
        ...
        # Use CallbackAPIVersion.VERSION2 to match the Pi-side publisher
    ...
    def on_mqtt_connect(self, client, userdata, flags, reason_code, properties):
        if reason_code == 0:
            ...
            self.get_logger().error(f'MQTT connection failed rc={reason_code}')
